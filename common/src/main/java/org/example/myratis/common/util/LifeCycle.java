...
import org.example.myratis.common.util.function.CheckedRunnable;
import org.example.myratis.common.util.function.CheckedSupplier;
...
public class LifeCycle {
  ...
  public final <T extends Throwable> void startAndTransition(
    ...
    try {
      ...
      //TODO: add again ReflectionUtils.isInstance(t, exceptionClasses)? State.NEW:
      transition(State.EXCEPTION);
      throw t;
    }
  }
